...
echo "CREATE USER 'edbarbos'@'localhost' IDENTIFIED BY '1234';" | mysql -u root
echo "GRANT ALL PRIVILEGES ON *.* TO 'edbarbos'@'localhost' WITH GRANT OPTION;" | mysql -u root
...
openssl req -newkey rsa:4096 -days 365 -nodes -x509 \
	-subj "/C=BR/ST=Sao Paulo/L=Sao Paulo/O=42SP/OU=edbarbos/CN=localhost/emailAddress=edbarbos@student.42sp.org" \
